 ...
 */
public class Cashexpenseposting  {
	...
	public Long getPostingsetupId() {
		return this.postingsetupId;
	}

	public void setPostingsetupId(Long postingsetupId) {
		this.postingsetupId = postingsetupId;
	}
