...
public class DataStoreManager {
    ...
    public void open() throws Exception {
        ...
        DataSource ds = (DataSource) ctx.lookup("java:comp/env/jdbc/pyramid");
...
//    }
    ...
    public AppuserDAO createAppuserDAO() {
        return new AppuserDAO(ds);
    }
    
    public RoleDAO createRoleDAO() {
        return new RoleDAO(ds);
    }
    
    public ResourceDAO createResourceDAO() {
        return new ResourceDAO(ds);
    }
    
    public PermissionentityDAO createPermissionentityDAO() {
        return new PermissionentityDAO(ds);
    }
