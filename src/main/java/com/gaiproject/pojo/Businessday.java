...
public class Businessday  {
	...
	private String businessdatestringformat;
	...
	public String getBusinessdatestringformat() {
		return this.businessdatestringformat;
	}

	public void setBusinessdatestringformat(String businessdatestringformat) {
		this.businessdatestringformat = businessdatestringformat;
	}
