CREATE DATABASE  IF NOT EXISTS `pyramid` /*!40100 DEFAULT CHARACTER SET utf8 COLLATE utf8_turkish_ci */;
USE `pyramid`;
...
/* GRANT ALL PRIVILEGES ON pyramid.* To 'roott'@'localhost' IDENTIFIED BY 'roott'; */
